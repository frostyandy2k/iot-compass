...
var spatialAwareness = function() {
	...
	function initDeviceOrientation(cb) {
		// $('#radartarget').html(window.DeviceOrientationEvent)
	...
	function getRoomData(cb) {
		...
		var livinglab_items = {
			"EmbeddedBusinessSystems": {
			  location: {dir: 50},
			  img: "demos–TecOIntranet/EBS_front_radar.png"
			},
			"VDAR": {
			  location: {dir: 60},
			  img: "demos–TecOIntranet/VDAR_Logo_radar.png"
			},
			"AudioLedLampe": {
			  location: {dir: 40},
			  status: true,
			  ...
			  img: "demos–TecOIntranet/ThumbAudioLed_radar.png"
			},
			"LedPowerDemo": {
			  location: {dir: 110},
			  img: "demos–TecOIntranet/ThumbLedPower_radar.png",
			},
			"AudioLedLampe1": {
			  location: {dir: 160},
			  status: true,
			...
			"PointAndClick": {
			  location: {dir: 180},
			  img: "demos–TecOIntranet/ThumbPointAndClick_radar.png",
			},
			"HealthCareDemo": {
			  location: {dir: 190},
			  img: "demos–TecOIntranet/ThumbKneeGuard_radar.png",
			},
			"TecoEnvboard": {
			  location: {dir: 200},
			  img: "demos–TecOIntranet/envboard-demo-neu_radar.png",
			},
			"RfidCommunicationDemo": {
			  location: {dir: 260},
			  img: "demos–TecOIntranet/ThumbRfidCollab_radar.png",
			},
			"AudioLedLampe2": {
			  location: {dir: 270},
			  status: true,
			...
			"MachineHealthDemo": {
			  location: {dir: 280},
			  img: "demos–TecOIntranet/ThumbMachineHealth_radar.png",
			},
			"AudioLedLampe3": {
			  location: {dir: 320},
			  status: true,
			...
			"LandmarkeDemo": {
			  location: {dir: 330},
			  img: "demos–TecOIntranet/Landmarke Demo_radar.png",
			},
		};
		itemsArray = livinglab_items;
		init();
		cb(livinglab_items);
	}
